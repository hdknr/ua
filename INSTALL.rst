========================================================================
** UA ** Installation Instructions
========================================================================

This section contains information about 
how to download and install **UA** in your system. 
...
To install **UA** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/ua.git#egg=ua

The above command will install the latest development release of **UA**.
